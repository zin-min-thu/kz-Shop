...
<ul class="breadcrumb">
    ...
    <li>
        <i class="icon-edit"></i>
        <a href="{{URL::to('/add-category')}}">Add Manufacture</a>
    </li>
</ul>
@if(session('message'))
            ...
            <form class="form-horizontal" action="{{url('/save-manufacture')}}" method="post">
              ...
              <fieldset>
                ...
                <div class="control-group hidden-phone">
                  <label class="control-label" for="manufacture-description">Manufacture Description</label>
                  <div class="controls">
                    <textarea class="cleditor" name="manufacture_description" rows="3"></textarea>
                  </div>
                </div>
                <div class="control-group">
                  <label class="control-label" for="manufacture-publication-status">Publication Status</label>
                  <div class="controls">
